(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/Dezimal1.loader.js";
    var config = {
        dataUrl: buildUrl + "/Dezimal1.data",
        frameworkUrl: buildUrl + "/Dezimal1.framework.js",
        codeUrl: buildUrl + "/Dezimal1.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "Dezimal1",
        productVersion: "1.13 vom 10.6.2023",
    };
